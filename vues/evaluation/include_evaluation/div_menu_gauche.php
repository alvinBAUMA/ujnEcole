...
<div class="container-fluid" style="background-color: #ffffff; padding-top: 50px; padding: 50px 10px 10px 10px">
    <legend class="bleu">Evalution des enseignants</legend>
    <ul class="list-group taille-15" style="border-color: #fff; padding: 0px">
        <a href="gEvaluation?ref=historique">
            <li class="list-group-item" style="border-top-color: #fff; border-left-color: #fff; border-right-color: #fff">
                <i class="fa fa-history fa-detail" style="background-color: #e1be05; color: #fff"></i> Historiques des evaluations

            </li>
        </a>

        <a href="gEvaluation?ref=nouveau">
            <li class="list-group-item" style="border-top-color: #fff; border-left-color: #fff; border-right-color: #fff">
                <i class="fa fa-plus fa-detail" style="background-color: #019284; color: #fff"></i> Nouvelle évaluation

            </li>
        </a>

        <a href="gEvaluation?ref=filtre">
            <li class="list-group-item" style="border-top-color: #fff; border-left-color: #fff; border-right-color: #fff">
                <i class="fa fa-users fa-detail" style="background-color: #0ba2de; color: #fff"></i> Consulter par enseignant
